...
@NoArgsConstructor
@AllArgsConstructor
//indexName 索引的名称（必填项） type:索引的类型，只能有一个（5.x版本不限个数，7.x版删除了type,）  shards 分片，默认1   replicas 备份，默认1
@Document(indexName = "product", type = "docs", shards = 3, replicas = 1)
@ApiModel("商品")
